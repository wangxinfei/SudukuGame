...
public class SudokuSolver {
    ...
    /**   Sudoku Rules
     * 1.Enumerates all empty cells in typewriter order (left to right, top to bottom)
    ...
    /**
     * Enumerates all empty cells in typewriter order (left to right, top to bottom)
