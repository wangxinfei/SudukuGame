...
public class GameLogic {
    ...
    /**
     * Check to see if the incoming state of the game is either Active (unsolved) or Complete (solved)
     *
     * Rules:
     ...
     * [0][2], [1][2], [2][2]
     *
     * Uses some dope problem-solving skills to select for each square
     * and compares them individually. (sounds much better to me)
     * Ranges:
    ...
    public static boolean collectionHasRepeats(List<Integer> collection) {
        //count occurrences of integers from 1-GRID_BOUNDARY, if Collections.frequency returns a value greater than 1, the square is invalid
